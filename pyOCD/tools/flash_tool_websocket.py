...
def main():
    ...
    if args.list_all:
        MbedBoard.listConnectedBoardsWS(host = args.websocket_host, port= args.websocket_port)
    else:
        board_selected = MbedBoard.chooseBoardWS(board_id=args.board_id, target_override=args.target_override,
                                               frequency=args.frequency,host = args.websocket_host, port= args.websocket_port)
